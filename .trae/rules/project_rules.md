...
2. **`.agents/skills/`** — skill packages (remote-plugin, repo-init, modelscope, handoff-context, concise-code-explanation, grill), each with SKILL.md and any supporting scripts/, references/, or agents/ files.
