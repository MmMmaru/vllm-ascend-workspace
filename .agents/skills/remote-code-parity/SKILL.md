...
- Bound local SSH operations with connect/keepalive settings and phase-appropriate subprocess timeouts; a half-open Windows SSH process must fail closed instead of waiting forever.
