...
(Worker_DP1_TP1_EP3 pid=409163) DEBUG 07-29 10:58:51 [sequence_parallelism_moe.py:192]     %all_gather : [num_users=1] = call_function[target=torch.ops.vllm.all_gather.default](args = (%alias, 0, 2, tp:0), kwargs = {})
(Worker_DP1_TP1_EP3 pid=409163) DEBUG 07-29 10:58:51 [sequence_parallelism_moe.py:192]     %slice_1 : [num_users=2] = call_function[target=torch.ops.aten.slice.Tensor](args = (%all_gather, 0, 0, %arg1_1), kwargs = {})
(Worker_DP1_TP1_EP3 pid=409163) DEBUG 07-29 10:58:51 [sequence_parallelism_moe.py:192]     %maybe_chunk_residual_1 : [num_users=1] = call_function[target=torch.ops.vllm.maybe_chunk_residual.default](args = (%slice_1, %getitem_1153), kwargs = {})
(Worker_DP1_TP1_EP3 pid=409163) DEBUG 07-29 10:58:51 [sequence_parallelism_moe.py:192]     %npu_add_rms_norm_bias_1 : [num_users=2] = call_function[target=torch.ops._C_ascend.npu_add_rms_norm_bias.default](args = (%slice_1, %maybe_chunk_residual_1, %arg13_1), kwargs = {})
(Worker_DP1_TP1_EP3 pid=409163) DEBUG 07-29 10:58:51 [sequence_parallelism_moe.py:192]     %getitem_18 : [num_users=1] = call_function[target=operator.getitem](args = (%npu_add_rms_norm_bias_1, 0), kwargs = {})
(Worker_DP1_TP1_EP3 pid=409163) DEBUG 07-29 10:58:51 [sequence_parallelism_moe.py:192]     %getitem_20 : [num_users=1] = call_function[target=operator.getitem](args = (%npu_add_rms_norm_bias_1, 2), kwargs = {})
(Worker_DP1_TP1_EP3 pid=409163) DEBUG 07-29 10:58:51 [sequence_parallelism_moe.py:192]     %unquantized_gemm_3 : [num_users=1] = call_function[target=torch.ops.vllm.unquantized_gemm.default](args = (%getitem_18, %arg14_1), kwargs = {})
(Worker_DP1_TP1_EP3 pid=409163) DEBUG 07-29 10:58:51 [sequence_parallelism_moe.py:192]     %qkv_rmsnorm_rope_default_46 : [num_users=3] = call_function[target=torch.ops.vllm.qkv_rmsnorm_rope.default](args = (%unquantized_gemm_3, %arg9_1, %arg7_1, %arg15_1, %arg16_1, 2048, 256, 128, 1e-06), kwargs = {})
(Worker_DP1_TP1_EP3 pid=409163) DEBUG 07-29 10:58:51 [sequence_parallelism_moe.py:192]     %getitem_1052 : [num_users=1] = call_function[target=operator.getitem](args = (%qkv_rmsnorm_rope_default_46, 0), kwargs = {})
(Worker_DP1_TP1_EP3 pid=409163) DEBUG 07-29 10:58:51 [sequence_parallelism_moe.py:192]     %getitem_1053 : [num_users=1] = call_function[target=operator.getitem](args = (%qkv_rmsnorm_rope_default_46, 1), kwargs = {})
(Worker_DP1_TP1_EP3 pid=409163) DEBUG 07-29 10:58:51 [sequence_parallelism_moe.py:192]     %getitem_1054 : [num_users=1] = call_function[target=operator.getitem](args = (%qkv_rmsnorm_rope_default_46, 2), kwargs = {})
(Worker_DP1_TP1_EP3 pid=409163) DEBUG 07-29 10:58:51 [sequence_parallelism_moe.py:192]     %empty_1 : [num_users=1] = call_function[target=torch.ops.aten.empty.memory_format](args = ([%arg1_1, 2048],), kwargs = {dtype: torch.bfloat16, device: npu:3, pin_memory: False})
(Worker_DP1_TP1_EP3 pid=409163) DEBUG 07-29 10:58:51 [sequence_parallelism_moe.py:192]     %view_17 : [num_users=1] = call_function[target=torch.ops.aten.view.default](args = (%getitem_1052, [-1, 16, 128]), kwargs = {})
(Worker_DP1_TP1_EP3 pid=409163) DEBUG 07-29 10:58:51 [sequence_parallelism_moe.py:192]     %view_19 : [num_users=1] = call_function[target=torch.ops.aten.view.default](args = (%getitem_1053, [-1, 2, 128]), kwargs = {})
(Worker_DP1_TP1_EP3 pid=409163) DEBUG 07-29 10:58:51 [sequence_parallelism_moe.py:192]     %view_20 : [num_users=1] = call_function[target=torch.ops.aten.view.default](args = (%getitem_1054, [-1, 2, 128]), kwargs = {})
(Worker_DP1_TP1_EP3 pid=409163) DEBUG 07-29 10:58:51 [sequence_parallelism_moe.py:192]     %auto_functionalized_v2_2 : [num_users=1] = call_function[target=torch.ops.higher_order.auto_functionalized_v2](args = (vllm.unified_attention_with_output.default,), kwargs = {query: %view_17, key: %view_19, value: %view_20, layer_name: model.layers.1.self_attn.attn, output_scale: None, kv_cache_dummy_dep: None, _output_base_index: 0, _output_size: (%arg1_1, 16, 128), _output_stride: (2048, 128, 1), _output_storage_offset: 0, _output_block_scale_base_index: None, _all_bases: [%empty_1]})
(Worker_DP1_TP1_EP3 pid=409163) DEBUG 07-29 10:58:51 [sequence_parallelism_moe.py:192]     %getitem_31 : [num_users=1] = call_function[target=operator.getitem](args = (%auto_functionalized_v2_2, 1), kwargs = {})
(Worker_DP1_TP1_EP3 pid=409163) DEBUG 07-29 10:58:51 [sequence_parallelism_moe.py:192]     %detach_5 : [num_users=1] = call_function[target=torch.ops.aten.detach.default](args = (%getitem_31,), kwargs = {})
(Worker_DP1_TP1_EP3 pid=409163) DEBUG 07-29 10:58:51 [sequence_parallelism_moe.py:192]     %view_23 : [num_users=1] = call_function[target=torch.ops.aten.view.default](args = (%detach_5, [-1, 16, 128]), kwargs = {})
(Worker_DP1_TP1_EP3 pid=409163) DEBUG 07-29 10:58:51 [sequence_parallelism_moe.py:192]     %view_24 : [num_users=1] = call_function[target=torch.ops.aten.view.default](args = (%view_23, [-1, 2048]), kwargs = {})
(Worker_DP1_TP1_EP3 pid=409163) DEBUG 07-29 10:58:51 [sequence_parallelism_moe.py:192]     %unquantized_gemm_4 : [num_users=1] = call_function[target=torch.ops.vllm.unquantized_gemm.default](args = (%view_24, %arg17_1), kwargs = {})
(Worker_DP1_TP1_EP3 pid=409163) DEBUG 07-29 10:58:51 [sequence_parallelism_moe.py:192]     %reduce_scatter_default_46 : [num_users=2] = call_function[target=torch.ops.vllm.reduce_scatter.default](args = (%unquantized_gemm_4, 0, 2, tp:0), kwargs = {})
(Worker_DP1_TP1_EP3 pid=409163) DEBUG 07-29 10:58:51 [sequence_parallelism_moe.py:192]     %maybe_chunk_residual_default_46 : [num_users=1] = call_function[target=torch.ops.vllm.maybe_chunk_residual.default](args = (%reduce_scatter_default_46, %getitem_20), kwargs = {})
(Worker_DP1_TP1_EP3 pid=409163) DEBUG 07-29 10:58:51 [sequence_parallelism_moe.py:192]     %npu_add_rms_norm_bias_default_46 : [num_users=2] = call_function[target=torch.ops._C_ascend.npu_add_rms_norm_bias.default](args = (%reduce_scatter_default_46, %maybe_chunk_residual_default_46, %arg18_1), kwargs = {})
(Worker_DP1_TP1_EP3 pid=409163) DEBUG 07-29 10:58:51 [sequence_parallelism_moe.py:192]     %getitem_1150 : [num_users=1] = call_function[target=operator.getitem](args = (%npu_add_rms_norm_bias_default_46, 0), kwargs = {})
(Worker_DP1_TP1_EP3 pid=409163) DEBUG 07-29 10:58:51 [sequence_parallelism_moe.py:192]     %getitem_1151 : [num_users=1] = call_function[target=operator.getitem](args = (%npu_add_rms_norm_bias_default_46, 2), kwargs = {})
(Worker_DP1_TP1_EP3 pid=409163) DEBUG 07-29 10:58:51 [sequence_parallelism_moe.py:192]     %all_gather_default_46 : [num_users=1] = call_function[target=torch.ops.vllm.all_gather.default](args = (%getitem_1150, 0, 2, tp:0), kwargs = {})
(Worker_DP1_TP1_EP3 pid=409163) DEBUG 07-29 10:58:51 [sequence_parallelism_moe.py:192]     %sequence_parallel_chunk_impl_1 : [num_users=2] = call_function[target=torch.ops.vllm.sequence_parallel_chunk_impl.default](args = (%all_gather_default_46,), kwargs = {})
(Worker_DP1_TP1_EP3 pid=409163) DEBUG 07-29 10:58:51 [sequence_parallelism_moe.py:192]     %unquantized_gemm_5 : [num_users=1] = call_function[target=torch.ops.vllm.unquantized_gemm.default](args = (%sequence_parallel_chunk_impl_1, %arg19_1), kwargs = {})
(Worker_DP1_TP1_EP3 pid=409163) DEBUG 07-29 10:58:51 [sequence_parallelism_moe.py:192]     %auto_functionalized_v2_3 : [num_users=1] = call_function[target=torch.ops.higher_order.auto_functionalized_v2](args = (vllm.moe_forward.default,), kwargs = {router_logits: %unquantized_gemm_5, shared_experts_input: None, input_ids: None, layer_name: from_forward_context, hidden_dim_unpadded: 0, _hidden_states_base_index: 0, _all_bases: [%sequence_parallel_chunk_impl_1]})
(Worker_DP1_TP1_EP3 pid=409163) DEBUG 07-29 10:58:51 [sequence_parallelism_moe.py:192]     %getitem_35 : [num_users=1] = call_function[target=operator.getitem](args = (%auto_functionalized_v2_3, 0), kwargs = {})
(Worker_DP1_TP1_EP3 pid=409163) DEBUG 07-29 10:58:51 [sequence_parallelism_moe.py:192]     %alias_1 : [num_users=1] = call_function[target=torch.ops.aten.alias.default](args = (%getitem_35,), kwargs = {})
(Worker_DP1_TP1_EP3 pid=409163) DEBUG 07-29 10:58:51 [sequence_parallelism_moe.py:192]     %all_gather_1 : [num_users=1] = call_function[target=torch.ops.vllm.all_gather.default](args = (%alias_1, 0, 2, tp:0), kwargs = {})
