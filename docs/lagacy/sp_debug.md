...
```bash
# 注：专用 SP 对照 E2E tests/e2e/pull_request/two_card/test_sp_pass.py 已随 SP pass 删除
# 当前功能验证请使用 scripts/serve_sp.sh 进行 SP on/off 手动对照（见 6.1 节）
# 旧命令仅作归档参考：
# cd /workspace/vllm-ascend
# export VLLM_WORKER_MULTIPROC_METHOD=spawn
# export VLLM_USE_MODELSCOPE=false
# export SP_TEST_MODEL=/home/weights/Qwen/Qwen3-30B-A3B
# pytest -sv tests/e2e/pull_request/two_card/test_sp_pass.py::test_qwen3_moe_sp_pass_matches_no_sp_tp2
```
