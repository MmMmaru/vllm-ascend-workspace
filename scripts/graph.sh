...
# export VLLM_COMPILE_CACHE_ROOT=./temp/vllm_flashcomm_debug

# pytest -q -s \
#   tests/e2e/pull_request/two_card/test_flashcomm_distributed.py::test_qwen3_moe_flashcomm1_tp2_fx_compile \
#   2>&1 | tee ../.log/flashcomm_debug1.log
# '
