docker exec -it xrs_vllm_main bash -lc '
cd /home/x50063850/vllm-workspace/vllm-ascend

export PYTHONPATH=/usr/local/Ascend/cann-9.0.1/python/site-packages:/home/x50063850/vllm-ascend:/home/x50063850/vllm
...
vllm serve /home/weights/Qwen/Qwen3-VL-2B-Instruct \
